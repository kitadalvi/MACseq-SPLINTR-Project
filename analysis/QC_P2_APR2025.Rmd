...
pca_plots <- function(df, type){
  ...
  p10<-DimPlot(seurat_object, group.by= 'Treatment_Combination',pt.size = 2, shape.by = 'Treatment_1', split.by = 'SPLINTR',dims = c(3,4))
  p11<-DimPlot(seurat_object, group.by= 'Treatment_Combination',pt.size = 2, shape.by = 'Treatment_1', split.by = 'SPLINTR',dims = c(5,6))
  p12 <-DimPlot(seurat_object, group.by= 'SPLINTR',pt.size = 2, shape.by = 'Treatment_1',dims = c(1,2))
  p13<-DimPlot(seurat_object, group.by= 'SPLINTR',pt.size = 2, shape.by = 'Treatment_1',dims = c(3,4))
  p14<-DimPlot(seurat_object, group.by= 'SPLINTR',pt.size = 2, shape.by = 'Treatment_1',dims = c(5,6))
  p15<-DimPlot(seurat_object, group.by= 'SPLINTR',pt.size = 2, shape.by = 'Treatment_1',dims = c(7,8))
  p16<-DimPlot(seurat_object, group.by= 'SPLINTR',pt.size = 2, shape.by = 'Treatment_1',dims = c(9,10))
  p17<-DimPlot(seurat_object, group.by= 'SPLINTR',pt.size = 2, shape.by = 'Treatment_1',dims = c(11,12))
  ggarrange(p1,p2,p3,p4,p5,p6,p7,p8,p9,p12,p13,p14,p15,p16,p17, nrow=5, ncol=3)
}
