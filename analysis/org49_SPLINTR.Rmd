...
org_data <- metadata[metadata$Organoid=='ORG49' 
...
### Entire Plate 
Visualising proportion of barcodes in all ORG49 wells across both timepoints:
...
plotBarcodeHistogram(dge.filtered[,c("H05",'H06','H07','H08','D05','D06','D07','D08','K05','K06','K07','K08')], topN = 25, alphaLowFreq = 0) + ggtitle("Top 25 barcodes in ORG49")

plotBarcodeHistogram(dge.filtered[,c("H05",'H06','H07','H08')], topN = 25, alphaLowFreq = 0) + ggtitle("Top 25 barcodes in DMSO treated ORG49")
#p2 + geom_bar(position="stack", stat="identity", width=,show.legend = FALSE) + ggtitle("Top 25 barcodes in ORG49")


```
```{r, fig.height=6, fig.width=5}
plotBarcodeHistogram(dge.filtered, samples=c("H05",'H06','H07','H08'), topN = 20, alphaLowFreq = 0) 
```
...
#### All
Visualising proportion of Barcodes in each ORG49 well across all treatments:
...
#### 24H
Visualising proportion of Barcodes in each ORG49 well across all treatments at 24H:
```{r, fig.height=8, fig.width=10}
...
#### 48H
Visualising proportion of Barcodes in each ORG49 well across all treatments at 48H:
```{r, fig.height=8, fig.width=10}
...
####  Comparison
Comparing proportion of Barcodes in each ORG49 well across at 24H VS at 48H:
...
org_data <- org_data[c("H05",'H06','H07','H08','D05','D06','D07','D08','K05','K06','K07','K08'),]
...
treatment <- paste(rep(c('DMSO','DMSO','DMSO','DMSO','Paclitaxel','Paclitaxel','Paclitaxel','Paclitaxel','SN38','SN38','SN38','SN38'),102))
...
plot + facet_wrap(~treatment, scales='free', switch='x') + 
  ...
  ggtitle("Distribution of top 10 barcodes in ORG49") + 
