...
long_pac_high <- makeContrasts((groupPa_Pacl.2.3287 - groupPa_DMSO.0.2)-(groupNC_Pacl.2.3287 - groupNC_DMSO.0.2), levels=colnames(design))

long_pac_low <- makeContrasts((groupPa_Pacl.1.5303 - groupPa_DMSO.0.2)-(groupNC_Pacl.1.5303 - groupNC_DMSO.0.2), levels=colnames(design))

long_sn38_high <- makeContrasts((groupSN_SN38.0.7319 - groupSN_DMSO.0.2)-(groupNC_SN38.0.7319 - groupNC_DMSO.0.2), levels=colnames(design))

long_sn38_low <- makeContrasts((groupSN_SN38.0.499 - groupSN_DMSO.0.2)-(groupNC_SN38.0.499 - groupNC_DMSO.0.2), levels=colnames(design))
```
...
write.csv(all_genes, file="../data/DEgenes/P2/ORG38_ncPACvsDMSO_high.csv")
...
create_dt_genes(org38_ncPAC_DEgenes)
write.csv(all_genes, file="../data/DEgenes/P2/ORG38_ncPACvsDMSO_low.csv")
...
write.csv(all_genes, file="../data/DEgenes/P2/ORG38_ncSN38vsDMSO_high.csv")
...
create_dt_genes(org38_ncSN38_DEgenes)
write.csv(all_genes, file="../data/DEgenes/P2/ORG38_ncSN38vsDMSO_low.csv")
...
write.csv(all_genes, file="../data/DEgenes/P2/ORG38_paPACvsDMSO_high.csv")
...
create_dt_genes(org38_paPAC_DEgenes)
write.csv(all_genes, file="../data/DEgenes/P2/ORG38_paPACvsDMSO_low.csv")
...
write.csv(all_genes, file="../data/DEgenes/P2/ORG38_snSN38vsDMSO_high.csv")
...
create_dt_genes(org38_snSN38_DEgenes)
write.csv(all_genes, file="../data/DEgenes/P2/ORG38_snSN38vsDMSO_low.csv")
...
##### (PAC_PAC - PAC_DMSO) - (NC_PAC-NC_DMSO) {.tabset}

###### High

Differentially expressed genes between (PAC_PAC - PAC_DMSO) and (NC_PAC-NC_DMSO) in ORG38 at high conc:

```{r}
### following limma workflow
### difference after correcting for effect of culture
fit <- lmFit(v, design)
fit <- contrasts.fit(fit, long_pac_high)
fit <- treat(fit, lfc=log2(1.2))
org38_long_pac_high_fit <- fit
all_genes <- topTreat(fit, number=Inf)
org38_long_pac_high_DEgenes <- topTreat(fit, p.value = p_value_threshold, number=Inf, sort.by='p')

create_dt_genes(all_genes)
write.csv(all_genes, file="../data/DEgenes/P2/ORG38_longPAC_high.csv")

### Print summary of DE genes table
total <- paste('• TOTAL DE genes:',length(rownames(org38_long_pac_high_DEgenes)))
up <- paste('• UPREGULATED:',sum(org38_long_pac_high_DEgenes$logFC>0))
down <- paste('• DOWNREGULATED:',sum(org38_long_pac_high_DEgenes$logFC<0))
summary=paste (total, up, down, sep="\n")
cat(summary[1])
```
...
### difference between PAC and DMSO 
fit <- lmFit(v, design)
fit <- contrasts.fit(fit, long_pac_low)
fit <- treat(fit, lfc=log2(1.2))
org38_long_pac_low_fit <- fit
all_genes <- topTreat(fit, number=Inf)
org38_long_pac_low_DEgenes <- topTreat(fit, p.value = p_value_threshold, number=Inf, sort.by='p')

create_dt_genes(org38_long_pac_low_DEgenes)
write.csv(all_genes, file="../data/DEgenes/P2/ORG38_longPAC_low.csv")

### Print summary of DE genes table
total <- paste('• TOTAL DE genes:',length(rownames(org38_long_pac_low_DEgenes)))
up <- paste('• UPREGULATED:',sum(org38_long_pac_low_DEgenes$logFC>0))
down <- paste('• DOWNREGULATED:',sum(org38_long_pac_low_DEgenes$logFC<0))
summary=paste (total, up, down, sep="\n")
cat(summary[1])
```


##### (SN38_SN38 - SN38_DMSO) - (NC_SN38-NC_DMSO) {.tabset}

###### High

Differentially expressed genes between (SN38_SN38 - SN38_DMSO) and (NC_SN38-NC_DMSO) in ORG38 at high conc:
...
fit <- lmFit(v, design)
fit <- contrasts.fit(fit, long_sn38_high)
fit <- treat(fit, lfc=log2(1.2))
org38_long_sn38_high_fit <- fit
all_genes <- topTreat(fit, number=Inf)
org38_long_sn38_high_DEgenes <- topTreat(fit, p.value = p_value_threshold, number=Inf, sort.by='p')

create_dt_genes(org38_long_sn38_high_DEgenes)
write.csv(all_genes, file="../data/DEgenes/P2/ORG38_longSN38_high.csv")

### Print summary of DE genes table
total <- paste('• TOTAL DE genes:',length(rownames(org38_long_sn38_high_DEgenes)))
up <- paste('• UPREGULATED:',sum(org38_long_sn38_high_DEgenes$logFC>0))
down <- paste('• DOWNREGULATED:',sum(org38_long_sn38_high_DEgenes$logFC<0))
summary=paste (total, up, down, sep="\n")
cat(summary[1])
```
...
Differentially expressed genes between (SN38_SN38 - SN38_DMSO) and (NC_SN38-NC_DMSO) in ORG38 at low conc:
...
fit <- contrasts.fit(fit, SN38_sn38vsdmso_low)
fit <- treat(fit, lfc=log2(1.2))
org38_long_sn38_low_fit <- fit
all_genes <- topTreat(fit, number=Inf)
org38_long_sn38_low_DEgenes <- topTreat(fit, p.value = p_value_threshold, number=Inf, sort.by='p')

create_dt_genes(org38_long_sn38_low_DEgenes)
write.csv(all_genes, file="../data/DEgenes/P2/ORG38_longSN38_low.csv")

### Print summary of DE genes table
total <- paste('• TOTAL DE genes:',length(rownames(org38_long_sn38_low_DEgenes)))
up <- paste('• UPREGULATED:',sum(org38_long_sn38_low_DEgenes$logFC>0))
down <- paste('• DOWNREGULATED:',sum(org38_long_sn38_low_DEgenes$logFC<0))
summary=paste (total, up, down, sep="\n")
cat(summary[1])
```
...
long_pac_high <- makeContrasts((groupPa_Pacl.0.01 - groupPa_DMSO.0.2)-(groupNC_Pacl.0.01 - groupNC_DMSO.0.2), levels=colnames(design))

long_pac_low <- makeContrasts((groupPa_Pacl.0.0022 - groupPa_DMSO.0.2)-(groupNC_Pacl.0.0022 - groupNC_DMSO.0.2), levels=colnames(design))

long_sn38_high <- makeContrasts((groupSN_SN38.0.0266 - groupSN_DMSO.0.2)-(groupNC_SN38.0.0266 - groupNC_DMSO.0.2), levels=colnames(design))

long_sn38_low <- makeContrasts((groupSN_SN38.0.0166 - groupSN_DMSO.0.2)-(groupNC_SN38.0.0166 - groupNC_DMSO.0.2), levels=colnames(design))
```
...
create_dt(org49_ncPAC_DEgenes)
write.csv(all_genes, file="../data/DEgenes/P2/ORG49_ncPACvsDMSO_high.csv")
...
write.csv(all_genes, file="../data/DEgenes/P2/ORG49_ncPACvsDMSO_low.csv")
...
write.csv(all_genes, file="../data/DEgenes/P2/ORG49_ncSN38vsDMSO_high.csv")
...
create_dt_genes(org49_ncSN38_DEgenes)
write.csv(all_genes, file="../data/DEgenes/P2/ORG49_ncSN38vsDMSO_low.csv")
...
create_dt(org49_paPAC_DEgenes)
write.csv(all_genes, file="../data/DEgenes/P2/ORG49_longPAC_high.csv")
...
write.csv(all_genes, file="../data/DEgenes/P2/ORG49_longPAC_low.csv")
...
write.csv(all_genes, file="../data/DEgenes/P2/ORG49_snSN38vsDMSO_high.csv")
...
create_dt_genes(org49_snSN38_DEgenes)
write.csv(all_genes, file="../data/DEgenes/P2/ORG49_snSN38vsDMSO_low.csv")
...
Differentially expressed genes between (PAC_PAC - PAC_DMSO) and (NC_PAC - NC_DMSO) in ORG49 at high conc:
...
fit <- treat(fit, lfc=log2(1.2))
all_genes <- topTreat(fit, number=Inf)
org49_long_pac_high_DEgenes <- topTreat(fit, p.value = p_value_threshold, number=Inf, sort.by='p')

create_dt(org49_long_pac_high_DEgenes)
write.csv(all_genes, file="../data/DEgenes/P2/ORG49_longPAC_high.csv")

### Print summary of DE genes table
total <- paste('• TOTAL DE genes:',length(rownames(org49_long_pac_high_DEgenes)))
up <- paste('• UPREGULATED:',sum(org49_long_pac_high_DEgenes$logFC>0))
down <- paste('• DOWNREGULATED:',sum(org49_long_pac_high_DEgenes$logFC<0))
summary=paste (total, up, down, sep="\n")
cat(summary[1])
```
...
Differentially expressed genes between (PAC_PAC - PAC_DMSO) and (NC_PAC - NC_DMSO) in ORG49 at low conc:
...
fit <- treat(fit, lfc=log2(1.2))
all_genes <- topTreat(fit, number=Inf)
org49_long_pac_low_DEgenes <- topTreat(fit, p.value = p_value_threshold, number=Inf, sort.by='p')

create_dt(org49_long_pac_low_DEgenes)
write.csv(all_genes, file="../data/DEgenes/P2/ORG49_longPAC_low.csv")

### Print summary of DE genes table
total <- paste('• TOTAL DE genes:',length(rownames(org49_long_pac_low_DEgenes)))
up <- paste('• UPREGULATED:',sum(org49_long_pac_low_DEgenes$logFC>0))
down <- paste('• DOWNREGULATED:',sum(org49_long_pac_low_DEgenes$logFC<0))
summary=paste (total, up, down, sep="\n")
cat(summary[1])
```
...
Differentially expressed genes between (SN38_SN38 - SN38_DMSO) and (NC_SN38 - NC_DMSO) in ORG49 at high conc:
...
fit <- contrasts.fit(fit, long_sn38_high)
fit <- treat(fit, lfc=log2(1.2))
org49_long_sn38_high_fit <- fit
all_genes <- topTreat(fit, number=Inf)
org49_long_sn38_high_DEgenes <- topTreat(fit, p.value = p_value_threshold, number=Inf, sort.by='p')

create_dt_genes(org49_long_sn38_high_DEgenes)
write.csv(all_genes, file="../data/DEgenes/P2/ORG49_longSN38_high.csv")

### Print summary of DE genes table
total <- paste('• TOTAL DE genes:',length(rownames(org49_long_sn38_high_DEgenes)))
up <- paste('• UPREGULATED:',sum(org49_long_sn38_high_DEgenes$logFC>0))
down <- paste('• DOWNREGULATED:',sum(org49_long_sn38_high_DEgenes$logFC<0))
summary=paste (total, up, down, sep="\n")
cat(summary[1])
```
...
create_dt_genes(org49_snSN38_DEgenes)
write.csv(all_genes, file="../data/DEgenes/P2/ORG49_longSN38_low.csv")
...
long_pac_high <- makeContrasts((groupPa_Pacl.2.3952 - groupPa_DMSO.0.2)-(groupNC_Pacl.2.3952 - groupNC_DMSO.0.2), levels=colnames(design))

long_pac_low <- makeContrasts((groupPa_Pacl.1.5968 - groupPa_DMSO.0.2)-(groupNC_Pacl.1.5968 - groupNC_DMSO.0.2), levels=colnames(design))

long_sn38_high <- makeContrasts((groupSN_SN38.0.0299 - groupSN_DMSO.0.2)-(groupNC_SN38.0.0299 - groupNC_DMSO.0.2), levels=colnames(design))

long_sn38_low <- makeContrasts((groupSN_SN38.0.02 - groupSN_DMSO.0.2)-(groupNC_SN38.0.02 - groupNC_DMSO.0.2), levels=colnames(design))
```
...
write.csv(all_genes, file="../data/DEgenes/P2/ORG66_ncPACvsDMSO_high.csv")
...
create_dt_genes(org66_ncPAC_DEgenes)
write.csv(all_genes, file="../data/DEgenes/P2/ORG66_ncPACvsDMSO_low.csv")
...
write.csv(all_genes, file="../data/DEgenes/P2/ORG66_ncSN38vsDMSO_high.csv")
...
create_dt_genes(org66_ncSN38_DEgenes)
write.csv(all_genes, file="../data/DEgenes/P2/ORG66_ncSN38vsDMSO_low.csv")
...
write.csv(all_genes, file="../data/DEgenes/P2/ORG66_paPACvsDMSO_high.csv")
...
create_dt_genes(org66_paPAC_DEgenes)
write.csv(all_genes, file="../data/DEgenes/P2/ORG66_paPACvsDMSO_low.csv")
...
write.csv(all_genes, file="../data/DEgenes/P2/ORG66_snSN38vsDMSO_high.csv")
...
create_dt_genes(org66_snSN38_DEgenes)
write.csv(all_genes, file="../data/DEgenes/P2/ORG66_snSN38vsDMSO_low.csv")
### Print summary of DE genes table
total <- paste('• TOTAL DE genes:',length(rownames(org66_snSN38_DEgenes)))
up <- paste('• UPREGULATED:',sum(org66_snSN38_DEgenes$logFC>0))
down <- paste('• DOWNREGULATED:',sum(org66_snSN38_DEgenes$logFC<0))
...
Differentially expressed genes between (PAC_PAC - PAC_DMSO) and (NC_PAC - NC_DMSO) in ORG66 at high conc:
...
fit <- contrasts.fit(fit, long_pac_high)
fit <- treat(fit, lfc=log2(1.2))
org66_long_pac_high_fit <- fit
all_genes <- topTreat(fit, number=Inf)
org66_long_pac_high_DEgenes <- topTreat(fit, p.value = p_value_threshold, number=Inf, sort.by='p')

create_dt(org66_long_pac_high_DEgenes)
write.csv(all_genes, file="../data/DEgenes/P2/ORG66_longPAC_high.csv")

### Print summary of DE genes table
total <- paste('• TOTAL DE genes:',length(rownames(org66_long_pac_high_DEgenes)))
up <- paste('• UPREGULATED:',sum(org66_long_pac_high_DEgenes$logFC>0))
down <- paste('• DOWNREGULATED:',sum(org66_long_pac_high_DEgenes$logFC<0))
summary=paste (total, up, down, sep="\n")
cat(summary[1])
```
...
Differentially expressed genes between (PAC_PAC - PAC_DMSO) and (NC_PAC - NC_DMSO) in ORG66 at low conc:
...
fit <- contrasts.fit(fit, long_pac_low)
fit <- treat(fit, lfc=log2(1.2))
org66_long_pac_low_fit <- fit
all_genes <- topTreat(fit, number=Inf)
org66_long_pac_low_DEgenes <- topTreat(fit, p.value = p_value_threshold, number=Inf, sort.by='p')

create_dt_genes(org66_long_pac_low_DEgenes)
write.csv(all_genes, file="../data/DEgenes/P2/ORG66_longPAC_low.csv")
### Print summary of DE genes table
total <- paste('• TOTAL DE genes:',length(rownames(org66_long_pac_low_DEgenes)))
up <- paste('• UPREGULATED:',sum(org66_long_pac_low_DEgenes$logFC>0))
down <- paste('• DOWNREGULATED:',sum(org66_long_pac_low_DEgenes$logFC<0))
summary=paste (total, up, down, sep="\n")
cat(summary[1])
```
...
Differentially expressed genes between (SN38_SN38 - SN38_DMSO) and (NC_SN38 - NC_DMSO) in ORG66 at high conc:
...
fit <- contrasts.fit(fit, long_sn38_high)
fit <- treat(fit, lfc=log2(1.2))
org66_long_sn38_high_fit <- fit
all_genes <- topTreat(fit, number=Inf)
org66_long_sn38_high_DEgenes <- topTreat(fit, p.value = p_value_threshold, number=Inf, sort.by='p')

create_dt(org66_long_sn38_high_DEgenes)
write.csv(all_genes, file="../data/DEgenes/P2/ORG66_longSN38_high.csv")

### Print summary of DE genes table
total <- paste('• TOTAL DE genes:',length(rownames(org66_long_sn38_high_DEgenes)))
up <- paste('• UPREGULATED:',sum(org66_long_sn38_high_DEgenes$logFC>0))
down <- paste('• DOWNREGULATED:',sum(org66_long_sn38_high_DEgenes$logFC<0))
summary=paste (total, up, down, sep="\n")
cat(summary[1])
```
...
Differentially expressed genes between (SN38_SN38 - SN38_DMSO) and (NC_SN38 - NC_DMSO) in ORG66 at low conc:

```{r}
### following limma workflow
### difference between SN38 and DMSO  
fit <- lmFit(v, design)
fit <- contrasts.fit(fit, long_sn38_low)
fit <- treat(fit, lfc=log2(1.2))
org66_long_sn38_low_fit <- fit
all_genes <- topTreat(fit, number=Inf)
org66_long_sn38_low_DEgenes <- topTreat(fit, p.value = p_value_threshold, number=Inf, sort.by='p')

create_dt(all_genes)
write.csv(all_genes, file="../data/DEgenes/P2/ORG66_longSN38_LOW                  .csv")

### Print summary of DE genes table
total <- paste('• TOTAL DE genes:',length(rownames(org66_long_sn38_low_DEgenes)))
up <- paste('• UPREGULATED:',sum(org66_long_sn38_low_DEgenes$logFC>0))
down <- paste('• DOWNREGULATED:',sum(org66_long_sn38_low_DEgenes$logFC<0))
summary=paste (total, up, down, sep="\n")
cat(summary[1])
```
