...
volcano_plot <- EnhancedVolcano(pac_genes,
                                ...
                                selectLab = c("MSLN","S100P","LGALS1","KRT13","SNRPN","LCN2","MSMB","PSCA","CYSRT1","GDF15","NAP1L1","AK4","EEF1A1","V1L1","CLIC1"),
                                boxedLabels = TRUE,
                                drawConnectors = TRUE,
                                arrowheads = FALSE,
                                pointSize = 3,
...
datatable(design)
```
Volcano plot of differentially expressed genes between PAC (all concentrations) and DMSO @ both timepoints:
...
Volcano plot of differentially expressed genes between SN38 (all concentrations) and DMSO @ both timepoints:
...
volcano_plot <- EnhancedVolcano(pacVSdmso_genes,
                                title="Paclitaxel VS DMSO",
                                subtitle="ORG49 (24H + 48H)",
                                lab=rownames(pacVSdmso_genes),
                                selectLab = c("CCL20","C4orf48"),
                                boxedLabels = TRUE,
                                drawConnectors = TRUE,
                                arrowheads = FALSE,
                               #xlim=c(-2,3), 
...
volcano_plot <- EnhancedVolcano(sn38VSdmso_genes,
                                ...
                                subtitle="ORG49 (24H + 48H)",
                                lab=rownames(sn38VSdmso_genes),
                                selectLab = c("SDHAP4","RGS2","IGFL2-AS1","ZNF681","C11orf52","LINC01943","DDX39B","TMEM151A","BBOF1","LINC01232"),
                                boxedLabels = TRUE,
                                drawConnectors = TRUE,
                                arrowheads = FALSE,
                                ylim=c(0,5),
...
• SPLINTR/treatment group (SPL1/SPL2)

• Concentration (IC12.5, IC25, IC50)

• Not including ORG or Time as only 1 ORG line and 1 timepoint selected

*** ORG66 UNLABELLED CELLS EXCLUDED FROM ANALYSIS
...
volcano_plot <- EnhancedVolcano(sn38VSdmso_genes,
                                ...
                                subtitle="ORG66",
                                lab=rownames(sn38VSdmso_genes),
                                selectLab = c("NIFK","RRM2","IER2","CCL20","CDC6","LINC03061","SNHG5","GAS5","CSTA","IER3","TMSB10","KRT19"),
                                boxedLabels = TRUE,
                                drawConnectors = TRUE,
                                arrowheads = FALSE,
                                pointSize = 3,
...
volcano_plot <- EnhancedVolcano(pacVSdmso_genes,
                                title="Paclitaxel VS DMSO",
                                subtitle="ORG66 (24H + 48H)",
                                lab=rownames(pacVSdmso_genes),
                                selectLab = c("CEACAM6","PHPT1","TSPAN8","SURF4","AGPAT2","LGALS4","UCP2","SERPINA1","REG4","UCP2","CD74"),
                                boxedLabels = TRUE,
                                drawConnectors = TRUE,
                                arrowheads = FALSE,
                                ylim=c(0,17),
