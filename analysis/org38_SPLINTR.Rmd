...
```{r, echo=TRUE}
##Loading data 
counts_path <- "/Users/dalvinikita/Documents/11_MACseq_PMMSq042/raw/MGC-AK-8417-Plate1_S170_readlength_30.tsv"
counts <- readBartabCounts(counts_path)
...
org_data <- metadata[metadata$Organoid=='ORG38',c('Well_ID',"Organoid","Treatment_1",'Time',"barcode", "bc.umi.count")]
...
plotBarcodeHistogram(barcode_data, topN = 20, )  
...
plotBarcodeHistogram(dge.filtered, topN = 1, alphaLowFreq = 0) + ggtitle("Top 500 BC in MACseq Plate 2")
