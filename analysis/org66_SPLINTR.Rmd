...
plotBarcodeHistogram(dge.filtered[,c("H19",'H20','H21','H22','D19','D20','D21','D22','K19','K20','K21','K22')], topN = 10, alphaLowFreq = 0) + ggtitle("Top 10 barcodes in ORG66")

#p2 + geom_bar(position="stack", stat="identity", width=,show.legend = FALSE) + ggtitle("Top 10 barcodes in ORG66")
```

```{r, fig.height=6, fig.width=5}
plotBarcodeHistogram(dge.filtered[,c("H19",'H20','H21','H22')], topN = 10, alphaLowFreq = 0)
```
