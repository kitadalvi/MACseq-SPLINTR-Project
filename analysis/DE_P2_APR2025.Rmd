...
```{r}
### selecting metadata and countdata relevant for ORG38
...
long_PAC_common <- makeContrasts(((treatmentPa_Pacl-treatmentPa_DMSO)+(treatmentNC_Pacl-treatmentNC_DMSO))/2,levels=colnames(design))
