...
write.csv(all_genes, file = '../data/DEgenes/P2/ORG38_ncPACvsDMSO.csv')
...
write.csv(all_genes, file = '../data/DEgenes/P2/ORG38_ncSN38vsDMSO.csv')
...
write.csv(all_genes, file = '../data/DEgenes/P2/ORG38_paPACvsDMSO.csv')
...
write.csv(all_genes, file = '../data/DEgenes/P2/ORG38_snSN38vsDMSO.csv')
...
saveRDS(org38_PDMSOvsDMSO_fit, file = '../output/P2/org38_paDMSOvsDMSO_fit.rds')

all_genes <- topTreat(fit, number=Inf)
org38_PDMSOvsDMSO_DEgenes <- topTreat(fit, p.value = p_value_threshold, number=Inf, sort.by='p')

write.csv(all_genes, file = '../data/DEgenes/P2/ORG38_paDMSOvsDMSO.csv')
...
ggsave(plot= volcano_plot, filename = '../output/P2/VP_org38_paDMSOvsDMSOpng', height=8, width=6)
```
...
write.csv(all_genes, file = '../data/DEgenes/P2/ORG38_longPAC.csv')
...
write.csv(all_genes, file = '../data/DEgenes/P2/ORG38_longSN38.csv')
...
write.csv(all_genes, file = '../data/DEgenes/P2/ORG49_ncPACvsDMSO.csv')
...
ggsave(plot= volcano_plot, filename = '../output/P2/VP_org49_ncpac.png', height=8, width=6)
```
...
write.csv(all_genes, file = '../data/DEgenes/P2/ORG49_ncSN38vsDMSO.csv')
...
write.csv(all_genes, file = '../data/DEgenes/P2/ORG49_paPACvsDMSO.csv')
...
write.csv(all_genes, file = '../data/DEgenes/P2/ORG49_snSN38vsDMSO.csv')
...
saveRDS(org49_PDMSOvsDMSO_fit, file = '../output/P2/org49_paDMSOvsDMSO_fit.rds')
all_genes <- topTreat(fit, number=Inf)
org49_PDMSOvsDMSO_DEgenes <- topTreat(fit, p.value = p_value_threshold, number=Inf, sort.by='p')
write.csv(all_genes, file = '../data/DEgenes/P2/ORG49_paDMSOvsDMSO.csv')
...
write.csv(all_genes, file = '../data/DEgenes/P2/ORG49_longPAC.csv')
...
write.csv(all_genes, file = '../data/DEgenes/P2/ORG49_longSN38.csv')
...
org66_ncPAC_fit <- fit
saveRDS(org66_ncPAC_fit, file = '../output/P2/org66_ncPACvsDMSO_fit.rds')
...
write.csv(all_genes, file = '../data/DEgenes/P2/ORG66_ncSN38vsDMSO.csv')
...
org66_paPAC_fit <- fit
saveRDS(org66_paPAC_fit, file = '../output/P2/org66_paPACvsDMSO_fit.rds')

all_genes <- topTreat(fit, number=Inf)
org66_paPAC_DEgenes <- topTreat(fit, p.value = p_value_threshold, number=Inf, sort.by='p')
write.csv(all_genes, file = '../data/DEgenes/P2/ORG66_paPACvsDMSO.csv')
...
saveRDS(org66_snSN38_fit, file = '../output/P2/org66_snSN38vsDMSO_fit.rds')
all_genes <- topTreat(fit, number=Inf)
org66_snSN38_DEgenes <- topTreat(fit, p.value = p_value_threshold, number=Inf, sort.by='p')
write.csv(all_genes, file = '../data/DEgenes/P2/ORG66_snSN38vsDMSO.csv')
...
saveRDS(org66_PDMSOvsDMSO_fit, file = '../output/P2/org66_paDMSOvsDMSO_fit.rds')

all_genes <- topTreat(fit, number=Inf)
org66_PDMSOvsDMSO_DEgenes <- topTreat(fit, p.value = p_value_threshold, number=Inf, sort.by='p')
write.csv(all_genes, file = '../data/DEgenes/P2/ORG66_paDMSOvsDMSO.csv')
...
write.csv(all_genes, file = '../data/DEgenes/P2/ORG66_longPAC.csv')
...
write.csv(all_genes, file = '../data/DEgenes/P2/ORG66_longSN38.csv')
