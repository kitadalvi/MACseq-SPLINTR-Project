...
org38_ncPAC_DEgenes <- topTreat(fit, p.value = p_value_threshold, number=Inf, sort.by='p', lfc=1.5)
...
all_genes <- topTreat(fit, number=Inf)
org38_ncSN38_DEgenes <- topTreat(fit, p.value = p_value_threshold, number=Inf, sort.by='p', lfc=1.5)
...
org38_paPAC_fit <- fit
all_genes <- topTreat(fit, number=Inf)
org38_paPAC_DEgenes <- topTreat(fit, p.value = p_value_threshold, number=Inf, sort.by='p', lfc=1.5)
...
all_genes <- topTreat(fit, number=Inf)
org38_snSN38_DEgenes <- topTreat(fit, p.value = p_value_threshold, number=Inf, sort.by='p', lfc=1.5)
...
fit <- treat(fit, fc=absolute_fold_change)
all_genes <- topTreat(fit, number=Inf)
org38_longPAC_DEgenes <- topTreat(fit, p.value = p_value_threshold, number=Inf, sort.by='p', lfc=1.5)
...
fit <- treat(fit, fc=absolute_fold_change)
all_genes <- topTreat(fit, number=Inf)
org38_longSN38_DEgenes <- topTreat(fit, p.value = p_value_threshold, number=Inf, sort.by='p', lfc=1.5)
...
org49_ncPAC_fit <- fit
all_genes <- topTreat(fit, number=Inf)
org49_ncPAC_DEgenes <- topTreat(fit, p.value = p_value_threshold, number=Inf, sort.by='p', lfc=1.5)
...
all_genes <- topTreat(fit, number=Inf)
org49_ncSN38_DEgenes <- topTreat(fit, p.value = p_value_threshold, number=Inf, sort.by='p', lfc=1.5)
...
fit <- treat(fit, fc=absolute_fold_change)
all_genes <- topTreat(fit, number=Inf)
org49_paPAC_DEgenes <- topTreat(fit, p.value = p_value_threshold, number=Inf, sort.by='p', lfc=1.5)
...
fit <- treat(fit, fc=absolute_fold_change)
all_genes <- topTreat(fit, number=Inf)
org49_snSN38_DEgenes <- topTreat(fit, p.value = p_value_threshold, number=Inf, sort.by='p', lfc=1.5)
...
fit <- treat(fit, fc=absolute_fold_change)
all_genes <- topTreat(fit, number=Inf)
org49_longPAC_DEgenes <- topTreat(fit, p.value = p_value_threshold, number=Inf, sort.by='p', lfc=1.5)
...
fit <- treat(fit, fc=absolute_fold_change)
all_genes <- topTreat(fit, number=Inf)
org49_longSN38_DEgenes <- topTreat(fit, p.value = p_value_threshold, number=Inf, sort.by='p', lfc=1.5)
...
org66_ncPAC_fit <- fit
all_genes <- topTreat(fit, number=Inf)
org66_ncPAC_DEgenes <- topTreat(fit, p.value = p_value_threshold, number=Inf, sort.by='p', lfc=1.5)
...
all_genes <- topTreat(fit, number=Inf)
org66_ncSN38_DEgenes <- topTreat(fit, p.value = p_value_threshold, number=Inf, sort.by='p', lfc=1.5)
...
org66_paPAC_fit <- fit
all_genes <- topTreat(fit, number=Inf)
org66_paPAC_DEgenes <- topTreat(fit, p.value = p_value_threshold, number=Inf, sort.by='p', lfc=1.5)
...
fit <- treat(fit, fc=absolute_fold_change)
all_genes <- topTreat(fit, number=Inf)
org66_snSN38_DEgenes <- topTreat(fit, p.value = p_value_threshold, number=Inf, sort.by='p', lfc=1.5)
...
fit <- treat(fit, fc=absolute_fold_change)
all_genes <- topTreat(fit, number=Inf)
org66_longPAC_DEgenes <- topTreat(fit, p.value = p_value_threshold, number=Inf, sort.by='p', lfc=1.5)
...
fit <- treat(fit, fc=absolute_fold_change)
all_genes <- topTreat(fit, number=Inf)
org66_longSN38_DEgenes <- topTreat(fit, p.value = p_value_threshold, number=Inf, sort.by='p', lfc=1.5)
...
limma::barcodeplot(org38_ncPAC_fit$t[,1], index=rownames(org38_ncPAC_DEgenes), index2= rownames(org38_paPAC_DEgenes), labels=c("Down in ncPAC","Up in ncPAC"))
legend("top",legend=c("ncPAC - ncDMSO genes","paPAC - paDMSO genes"),lwd=2,box.lty=0,col=c("red","blue"),title='Geneset', cex=0.8, border=NULL, inset=c(0.3,-0.2), xpd=NA)
```

#### ORG38 SN38
```{r, fig.height=5, fig.width=6}
limma::barcodeplot(org38_ncSN38_fit$t[,1], index=rownames(org38_ncSN38_DEgenes), index2= rownames(org38_snSN38_DEgenes), labels=c("Down in ncSN38","Up in ncSN38"))
legend("top",legend=c("ncSN38 - ncDMSO genes","snSN38 - snDMSO genes"),lwd=2,box.lty=0,col=c("red","blue"), title='Geneset', cex=0.8, border=NULL, inset=c(0.3,-0.2), xpd=NA)
```

#### ORG49 SN38
```{r, fig.height=5, fig.width=6}
limma::barcodeplot(org49_ncSN38_fit$t[,1], index=rownames(org49_ncSN38_DEgenes), index2= rownames(org49_snSN38_DEgenes), labels=c("Down in ncSN38","Up in ncSN38"))
legend("top",legend=c("ncSN38 - ncDMSO genes","snSN38 - snDMSO genes"),lwd=2,box.lty=0,col=c("red","blue"), title='Geneset', cex=0.8, border=NULL, inset=c(0.3,-0.2), xpd=NA)
```

#### ORG66 PAC
```{r, fig.height=5, fig.width=6}
limma::barcodeplot(org66_ncPAC_fit$t[,1], index=rownames(org66_ncPAC_DEgenes), index2= rownames(org66_paPAC_DEgenes), labels=c("Down in ncPAC","Up in ncPAC"))
legend("top",legend=c("ncPAC - ncDMSO genes","paPAC - paDMSO genes"),lwd=2,box.lty=0,col=c("red","blue"), title='Geneset', cex=0.8, border=NULL, inset=c(0.3,-0.2), xpd=NA)
```

#### ORG66 SN38
```{r, fig.height=5, fig.width=6}
limma::barcodeplot(org66_ncSN38_fit$t[,1], index=rownames(org66_ncSN38_DEgenes), index2= rownames(org66_snSN38_DEgenes), labels=c("Down in ncSN38","Up in ncSN38"))
legend("top",legend=c("ncSN38 - ncDMSO genes","snSN38 - snDMSO genes"),lwd=2,box.lty=0,col=c("red","blue"), title='Geneset', cex=0.8, border=NULL, inset=c(0.3,-0.2), xpd=NA)
```
...
```{r, fig.height=5, fig.width=6}
limma::barcodeplot(org38_ncPAC_fit$t[,1], index=rownames(org38_ncPAC_DEgenes), index2= rownames(org38_ncSN38_DEgenes), labels=c("Down in ncPAC","Up in ncPAC"))
legend("top",legend=c("ncPAC - ncDMSO genes","ncSN38 - ncDMSO genes"),lwd=2,box.lty=0,col=c("red","blue"), title='Geneset', cex=0.8, border=NULL, inset=c(0.3,-0.2), xpd=NA)
```

ORG66:

```{r, fig.height=5, fig.width=6}
limma::barcodeplot(org66_ncPAC_fit$t[,1], index=rownames(org66_ncPAC_DEgenes), index2= rownames(org66_ncSN38_DEgenes), labels=c("Down in ncPAC","Up in ncPAC"))
legend("top",legend=c("ncPAC - ncDMSO genes","ncSN38 - ncDMSO genes"),lwd=2,box.lty=0,col=c("red","blue"), title='Geneset', cex=0.8, border=NULL, inset=c(0.3,-0.2), xpd=NA)
```
...
```{r, fig.height=5, fig.width=6}
limma::barcodeplot(org38_paPAC_fit$t[,1], index=rownames(org38_paPAC_DEgenes), index2= rownames(org38_snSN38_DEgenes), labels=c("Down in paPAC","Up in paPAC"))
legend("top",legend=c("paPAC - paDMSO genes","snSN38 - snDMSO genes"),lwd=2,box.lty=0,col=c("red","blue"), title='Geneset', cex=0.8, border=NULL, inset=c(0.3,-0.2), xpd=NA)
```

ORG66:

```{r, fig.height=5, fig.width=6}
limma::barcodeplot(org66_paPAC_fit$t[,1], index=rownames(org66_paPAC_DEgenes), index2= rownames(org66_snSN38_DEgenes), labels=c("Down in paPAC","Up in paPAC"))
legend("top",legend=c("paPAC - paDMSO genes","snSN38 - snDMSO genes"),lwd=2,box.lty=0,col=c("red","blue"), title='Geneset', cex=0.8, border=NULL, inset=c(0.3,-0.2), xpd=NA)
```
...
NC_PAC - NC_DMSO: 
```{r, fig.height=5, fig.width=6}
limma::barcodeplot(org38_ncPAC_fit$t[,1], index=rownames(org38_ncPAC_DEgenes), index2= rownames(org66_ncPAC_DEgenes), labels=c("Down in ncPAC","Up in ncPAC"))
legend("top",legend=c("ORG38 ncPAC genes","ORG66 ncPAC genes"),lwd=2,box.lty=0,col=c("red","blue"), title='Geneset', cex=0.8, border=NULL, inset=c(0.3,-0.2), xpd=NA)
```

NC_SN38 - NC_DMSO: 

```{r, fig.height=5, fig.width=6}
limma::barcodeplot(org38_ncSN38_fit$t[,1], index=rownames(org38_ncSN38_DEgenes), index2= rownames(org66_ncSN38_DEgenes), labels=c("Down in ncSN38","Up in ncSN38"))
legend("top",legend=c("ORG38 ncSN38 genes","ORG66 ncSN38 genes"),lwd=2,box.lty=0,col=c("red","blue"), title='Geneset', cex=0.8, border=NULL, inset=c(0.3,-0.2), xpd=NA)
```
...
paPAC - paDMSO: 
```{r, fig.height=5, fig.width=6}
limma::barcodeplot(org38_paPAC_fit$t[,1], index=rownames(org38_paPAC_DEgenes), index2= rownames(org66_paPAC_DEgenes), labels=c("Down in paPAC","Up in paPAC"))
legend("top",legend=c("ORG38 paPAC genes","ORG66 paPAC genes"),lwd=2,box.lty=0,col=c("red","blue"), title='Geneset', cex=0.8, border=NULL, inset=c(0.3,-0.2), xpd=NA)
```

snSN38 - snDMSO: 
```{r, fig.height=5, fig.width=6}
limma::barcodeplot(org38_snSN38_fit$t[,1], index=rownames(org38_snSN38_DEgenes), index2= rownames(org66_snSN38_DEgenes), labels=c("Down in snSN38","Up in snSN38"))
legend("top",legend=c("ORG38 snSN38 genes","ORG66 snSN38 genes"),lwd=2,box.lty=0,col=c("red","blue"), title='Geneset', cex=0.8, border=NULL, inset=c(0.3,-0.2), xpd=NA)
```
