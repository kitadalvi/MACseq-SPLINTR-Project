...
In summary: 4481 genes differentially expressed between Paclitaxel IC12.5 and DMSO at 48H:
```{r}
datatable(DEgenes)
```
...
In summary: 4655 genes differentially expressed between Paclitaxel IC25 and DMSO at 48H:
```{r}
datatable(DEgenes)
```
...
In summary: 4324 genes differentially expressed between Paclitaxel IC50 and DMSO at 48H:
```{r}
datatable(DEgenes)
```
...
In summary: 464 genes differentially expressed between SN38 IC12.5 and DMSO at 48H:
```{r}
datatable(DEgenes)
```
...
In summary: 742 genes differentially expressed between SN38 IC25 and DMSO at 48H:
```{r}
datatable(DEgenes)
```
...
In summary: 765 genes differentially expressed between SN38 IC50 and DMSO at 48H:
```{r}
datatable(DEgenes)
```
...
In summary: 2 genes differentially expressed between Paclitaxel IC25 and DMSO at 48H:
```{r}
datatable(DEgenes)
```
...
In summary: 29 genes differentially expressed between Paclitaxel IC50 and DMSO at 48H:
```{r}
datatable(DEgenes)
```
...
In summary: 48 genes differentially expressed between SN38 IC25 and DMSO at 48H:
```{r}
datatable(DEgenes)
```
...
In summary: 232 genes differentially expressed between SN38 IC50 and DMSO at 48H:
```{r}
datatable(DEgenes)
```
...
In summary: 345 genes differentially expressed between Paclitaxel IC12.5 and DMSO at 48H:
```{r}
datatable(DEgenes)
```
...
In summary: 629 genes differentially expressed between Paclitaxel IC25 and DMSO at 48H:
```{r}
datatable(DEgenes)
```
...
In summary: 503 genes differentially expressed between Paclitaxel IC50 and DMSO at 48H:
```{r}
datatable(DEgenes)
```
...
In summary: 27 genes differentially expressed between SN38 IC25 and DMSO at 48H:
```{r}
datatable(DEgenes)
```
...
In summary: 102 genes differentially expressed between SN38 IC50 and DMSO at 48H:
```{r}
datatable(DEgenes)
```
